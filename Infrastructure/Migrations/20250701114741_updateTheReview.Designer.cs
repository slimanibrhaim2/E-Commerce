...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250701114741_updateTheReview")]
    partial class updateTheReview
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Infrastructure.Models.ReviewDAO", b =>
                {
                    ...
                    b.HasOne("Infrastructure.Models.OrderDAO", null)
                        .WithMany("Reviews")
                    ...
                    b.HasOne("Infrastructure.Models.UserDAO", "Provider")
                        .WithMany()
                        .HasForeignKey("ProviderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Infrastructure.Models.UserDAO", "Reviewer")
                        .WithMany()
                        .HasForeignKey("ReviewerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Infrastructure.Models.UserDAO", null)
                        .WithMany("Reviews")
