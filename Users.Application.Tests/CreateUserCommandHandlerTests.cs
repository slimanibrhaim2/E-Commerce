...
public class CreateUserCommandHandlerTests
{
    ...
    private CreateUserCommandHandler CreateHandler() =>
        new(_userRepoMock.Object, _uowMock.Object, _loggerMock.Object, _mediatorMock.Object);
    ...
    public async Task CreateUser_Success_WhenDataIsValid()
    {
        ...
        _mediatorMock.Setup(m => m.Send(It.IsAny<IRequest<Result<Guid>>>(), It.IsAny<CancellationToken>()))
                   .ReturnsAsync(Result<Guid>.Ok(Guid.NewGuid(), "تم إنشاء التقييم بنجاح", ResultStatus.Success));
        ...
        Assert.Equal("تم إنشاء الحساب بنجاح", result.Message);
    ...
    public async Task CreateUser_Fails_WhenExceptionThrown()
    {
        ...
        // Assert
        Assert.False(result.Success);
        Assert.Equal("حدث خطأ أثناء إنشاء الحساب", result.Message);
